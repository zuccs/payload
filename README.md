...
> [!IMPORTANT]
> 🎉 <strong>The Payload 3.0 beta is now available!</strong> You can now deploy Payload natively within any Next.js app folder. Read more in the <a target="_blank" href="https://payloadcms.com/blog/30-beta-install-payload-into-any-nextjs-app-with-one-line" rel="dofollow"><strong>announcement post</strong></a>.
